...
- **Round 2 (adversarial re-review, 2026-06-13): 28 code/UX + 6 docs + 1 security = 35 NEW items.**
  ...
  Progress: 8 DONE (R2-01–R2-07, R2-19) · 27 TODO. **All 5 Round-2 Highs complete.**
- Migrations: ✅ all 19 applied to Neon via `npm run db:migrate` (2026-06-12), verified live
- Current branch: `main` · **Last resume point: R2-08**
...
- **R2-07** → DONE: `feed/refresh` now reads device id via `extractDeviceId(req)` (UUID-shape
  validation) instead of the raw `dd_device_id` cookie (SEC-H1 sibling). Gate green. Commit: pending.
- RESUME AT: **R2-08**
