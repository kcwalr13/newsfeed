...
- **Round 5 (Product — content mix, curator voice & feel, 2026-06-14): 8 NEW items, all TODO.** From Kyle's
  ...
  (#3 — the headline). Build order A → B → C → D. **Last resume point: R5-C2.**
  Progress: **4 DONE (R5-A1, R5-B1, R5-B2, R5-C1) · 4 TODO.**
...
- **R5-C1** → DONE. Personalized curator note (backend). `Article.curatorNote?: string` (survives
  ...
  `app/api/feed/today/route.ts`. Gate green. Commit: pending.
- RESUME AT: **R5-C2**
