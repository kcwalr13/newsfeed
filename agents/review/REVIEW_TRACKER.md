...
- **Round 5 (Product — content mix, curator voice & feel, 2026-06-14): 8 NEW items, all TODO.** From Kyle's
  ...
  (#3 — the headline). Build order A → B → C → D. **Last resume point: R5-D3.**
  Progress: **7 DONE (R5-A1, R5-B1, R5-B2, R5-C1, R5-C2, R5-D1, R5-D2) · 1 TODO.**
...
- **R5-D2** → DONE. Card variants by `format` in `ArticleCard`: compact (no hero, tighter padding, 19px title)
  ...
  uppercase format tag in the meta row. File: `app/components/ArticleCard.tsx`. Gate green. Commit: pending.
- RESUME AT: **R5-D3**
