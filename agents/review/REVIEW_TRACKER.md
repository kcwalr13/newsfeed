...
- **Round 3 (Product — vision alignment, 2026-06-13): 17 NEW items.** Precise plan:
  ...
  **Round 3 progress: 8 DONE (B + A workstreams, P3-C1) · 9 TODO. Last resume point: P3-C2.**
...
- [x] **P3-C1** · Adaptive aesthetic weight: ramp source/aesthetic `0.70/0.30 → ~0.50/0.50` as `feedback_count` grows (trust source early, taste later); keep the blend-weight startup assertion. (`lib/config/aesthetic.ts`, `ranker.ts`) Acceptance: 0 feedback ≈ today; ample feedback → aesthetic ≥0.45. · **DONE** · Commit: pending
...
- **P3-C1** → DONE: adaptive aesthetic weight. New `aestheticWeightForFeedback` ramps 0.30→0.50 linearly,
  ...
  Gate green. Commit: pending. **Kyle: eyeball ranking feel on the deploy.**
- RESUME AT: **P3-C2**
