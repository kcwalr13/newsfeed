...
- **Round 4 (post-Round-3 adversarial review, 2026-06-14): 13 NEW items, all TODO.** See the "ROUND 4"
  ...
  Round-4 progress: **8 DONE (R4-01, R4-08, R4-02, R4-03, R4-04, R4-09, R4-10, R4-11) · 5 TODO (Lows).** **Last resume point: R4-05.**
...
- **R4-11** → DONE: shared `isValidDeviceId` between `extractDeviceId` and `/dashboard` (dropped the
  ...
  Gate green. Commit: pending.
- RESUME AT: **R4-05** (Round 4 Lows — R4-05/06/07/12/13 may share one `chore(R4-L)` commit)
