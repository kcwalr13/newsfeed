...
- **Round 3 (Product — vision alignment, 2026-06-13): 17 NEW items.** Precise plan:
  ...
  **Round 3 progress: 2 DONE (P3-B1, P3-B2) · 15 TODO. Last resume point: P3-B3.**
...
- [x] **P3-B2** · Add a `category` field to every source (old + new) — science/philosophy/ideas/economics/psychology/culture/music/art/design/film/literature (mapping in design §3). Extend the `Source` type; thread category onto `Article` (or resolve by slug at rank time). · **DONE** · Commit: pending
...
- **P3-B2** → DONE: backfilled `category` onto the 12 original sources (all 23 now categorized across 11
  ...
  discovered. Verified: data integrity (0 missing/invalid), resolver spot-checks, gate green. Commit: pending.
- RESUME AT: **P3-B3**
