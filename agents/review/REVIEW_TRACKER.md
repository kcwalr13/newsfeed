...
- **Round 5 (Product — content mix, curator voice & feel, 2026-06-14): 8 NEW items, all TODO.** From Kyle's
  ...
  (#3 — the headline). Build order A → B → C → D. **Last resume point: R5-D2.**
  Progress: **6 DONE (R5-A1, R5-B1, R5-B2, R5-C1, R5-C2, R5-D1) · 2 TODO.**
...
- **R5-D1** → DONE (THE HEADLINE — format mix guarantee). `Article.format` + `ContentFormat`; resolved on
  ...
  `lib/pipeline/displayedFeed.ts`, `app/api/feed/today/route.ts`. Gate green. Decision logged. Commit: pending.
- RESUME AT: **R5-D2**
