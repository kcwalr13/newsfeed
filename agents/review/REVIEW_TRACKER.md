...
- **Round 3 (Product — vision alignment, 2026-06-13): 17 NEW items.** Precise plan:
  ...
  **Round 3 progress: 10 DONE (B + A + C workstreams) · 7 TODO. Last resume point: P3-D1.**
...
- [x] **P3-C3** · Category diversity in the displayed 7 — span ≥4 categories (no all-science issue). Acceptance: displayed issues span ≥4 categories when possible. · **DONE** · Commit: pending
...
- **P3-C3** → DONE: ≥4 categories in the displayed 7. New `ensureCategorySpread` runs after C2 in the feed
  ...
  4 unfamiliar + 4 cats) + gate green. Commit: pending.
