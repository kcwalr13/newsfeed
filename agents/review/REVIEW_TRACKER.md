...
- **Round 3 (Product — vision alignment, 2026-06-13): 17 NEW items.** Precise plan:
  ...
  **Round 3 progress: 3 DONE (P3-B1, P3-B2, P3-B3 — B workstream complete) · 14 TODO. Last resume point: P3-A1.**
...
- [x] **P3-B3** · Per-source + per-category diversity caps so the 14 fixed-pipeline slots span many sources/categories (tune `MAX_ARTICLES_PER_SOURCE` + a soft per-category cap). Acceptance: fixed portion spans ≥6 sources, ≥4 categories. · **DONE** · Commit: pending
