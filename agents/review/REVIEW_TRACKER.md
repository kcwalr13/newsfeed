...
- **Round 3 (Product — vision alignment, 2026-06-13): 17 NEW items.** Precise plan:
  ...
  **Round 3 progress: 14 DONE + 1 DEFERRED (D4 optional) · 2 TODO (E2–E3). Last resume point: P3-E2.**
...
- [x] **P3-E1** · Build a ~16-piece calibration set spanning categories AND tonal poles (contemplative↔propulsive, playful↔serious, specialist↔generalist…), drawn live from the first assembled batch (preferred) or a small committed seed fallback. · **DONE** · Commit: pending
...
- **P3-E1** → DONE: `lib/onboarding/calibration.ts` `selectCalibrationSet` (category round-robin + tonal-extremity
  ...
  Verified live: 16 pieces / 4 categories from the batch. Gate green. Commit: pending.
- RESUME AT: **P3-E2**
