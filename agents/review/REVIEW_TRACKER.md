...
- **R4-05/06/07/12/13 (Lows)** → DONE, one `chore(R4-L)` commit. R4-05: re-apply `applyDiversityCap`
  ...
  permanently consuming onboarding. Two decisions logged (R4-05, R4-07). Gate green. Commit: pending.
