...
- **Round 4 (post-Round-3 adversarial review, 2026-06-14): 13 NEW items, all TODO.** See the "ROUND 4"
  ...
  Round-4 progress: **6 DONE (R4-01, R4-08, R4-02, R4-03, R4-04, R4-09) · 7 TODO.** **Last resume point: R4-10.**
...
- **R4-09** → DONE: dashboard exploration-budget denominator `/ 7` → `/ {EXPLORATION_CEILING}` (6, the
  real clamp ceiling) so it can read full. Gate green. Commit: pending.
- RESUME AT: **R4-10**
