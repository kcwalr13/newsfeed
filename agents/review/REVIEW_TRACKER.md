...
- **Round 3 (Product — vision alignment, 2026-06-13): 17 NEW items.** Precise plan:
  ...
  **Round 3 progress: 11 DONE (B + A + C workstreams, P3-D1) · 6 TODO. Last resume point: P3-D2.**
...
- [x] **P3-D1** · Metrics computed on the fly (no migration) from `article_batches` + `feedback`: % discovery vs fixed (today/7d/30d), distinct sources/week, category distribution, exploration-acceptance rate, taste maturity (feedback_count, is_drifting, short-term count). (`lib/db/metrics.ts`) · **DONE** · Commit: pending
...
- **P3-D1** → DONE: `lib/db/metrics.ts` `computeMetrics` (no migration) — discovery share (today/7d/30d),
  ...
  categoryDist science 310/philosophy 155/ideas 151/discovery 4 — the monochrome pre-Round-3 state). Commit: pending.
- RESUME AT: **P3-D2**
