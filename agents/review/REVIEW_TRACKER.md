...
- **Round 5 (Product — content mix, curator voice & feel, 2026-06-14): 8 NEW items, all TODO.** From Kyle's
  ...
  (#3 — the headline). Build order A → B → C → D. **Last resume point: R5-C1.**
  Progress: **3 DONE (R5-A1, R5-B1, R5-B2) · 5 TODO.**
...
- **R5-B2** → DONE. Reader thin-body fallback. Body gate is now
  ...
  File: `app/articles/[id]/page.tsx`. Gate green. Commit: pending.
- RESUME AT: **R5-C1**
