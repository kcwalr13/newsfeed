...
- **Round 3 (Product — vision alignment, 2026-06-13): 17 NEW items.** Precise plan:
  ...
  **Round 3 progress: 15 DONE + 1 DEFERRED (D4 optional) · 1 TODO (E3). Last resume point: P3-E3.**
...
- [x] **P3-E2** · First-run calibration UI (title·dek·source·category, like/pass, optional tone preference), gated by the existing `tangent_onboarding_dismissed` flag. (`app/onboarding/*`) · **DONE** · Commit: pending
