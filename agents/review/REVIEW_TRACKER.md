...
- **Round 3 (Product — vision alignment, 2026-06-13): 17 NEW items.** Precise plan:
  ...
  **Round 3 progress: 7 DONE (B + A workstreams) · 10 TODO. Last resume point: P3-C1.**
...
- [x] **P3-A4** · Record `discoveryCount` + discovered source domains in batch/issue metadata for the dashboard. Acceptance: exposed via issue meta / feed API. · **DONE** · Commit: pending
