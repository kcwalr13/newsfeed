...
- **Round 2 (adversarial re-review, 2026-06-13): 28 code/UX + 6 docs + 1 security = 35 NEW items.**
  ...
  Progress: 10 DONE (R2-01–R2-09, R2-19) · 25 TODO. **All 5 Round-2 Highs complete.**
- Migrations: ✅ all 19 applied to Neon via `npm run db:migrate` (2026-06-12), verified live
- Current branch: `main` · **Last resume point: R2-10**
...
- **R2-09** → DONE: clamp dwell/paragraph-index to `MAX_DWELL_SECONDS=99999` / `MAX_PARAGRAPH_INDEX
  ...
  INTEGER/NUMERIC(7,2) overflow → 500. Gate green + live-Neon boundary check. Commit: pending.
- RESUME AT: **R2-10**
