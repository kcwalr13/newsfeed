...
- **Round 3 (Product — vision alignment, 2026-06-13): 17 NEW items.** Precise plan:
  ...
  **Round 3 progress: 9 DONE (B + A workstreams, P3-C1, P3-C2) · 8 TODO. Last resume point: P3-C3.**
...
- [x] **P3-C2** · Guarantee ≥2 of the displayed 7 come from a never-before-shown source (prefer discovered/novel; fall back to least-recently-shown fixed). Acceptance: ≥2 unfamiliar sources in the shown set when the pool allows. · **DONE** · Commit: pending
...
- **P3-C2** → DONE: ≥2 never-before-shown sources in the displayed 7. New `getShownSourceDomains` (storage)
  ...
  uses the shared const. Verified by 3-scenario sim + gate green. Commit: pending.
- RESUME AT: **P3-C3**
